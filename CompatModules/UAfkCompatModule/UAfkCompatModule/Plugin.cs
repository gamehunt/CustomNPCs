...
{
    public class Plugin : Exiled.API.Features.Plugin<UAfkCompatModule.Config>
    {
        public override string Author { get; } = "gamehunt";
        public override string Name { get; } = "UAfkCompatModule";
        public override string Prefix { get; } = "UAfkCompatModule";
        ...
        public override void OnEnabled()
        {
            try
            {
                ...
                if (NPCPlugin == null)
                {
                    Log.Error("Failed to load UAfk compat module addon: UAfk not found!");
                    return;
                }

                if (Exiled.Loader.Loader.Plugins.Where(p => p.Prefix == "uAFK").FirstOrDefault() == null)
                {
                    Log.Error("Failed to load UAfk compat module addon: UAfk not found!");
                    return;
                }
                ...
                Log.Info($"UAfk compat module loaded. @gamehunt");
            }
            catch (Exception e)
            {
